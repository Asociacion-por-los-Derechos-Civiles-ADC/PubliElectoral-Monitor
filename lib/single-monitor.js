...
'id="100072377679148" date="2022-09-01T03:00:00.007Z" campaign="Plebiscito Constitucional" force_all=true'

const args = process.argv
if (args[2] === 'help' || args[2] === '--help' || args[2] === '-h') {
  const help = '================ AYUDA ================\n'
  +'Este script obtiene las publicaciones de Facebook de determinada cuenta de una campaña específica entre un rango de fechas.\n\n'
  +'Parametros ejemplo:\n'
  +'   * ID de Facebook de la cuenta (fbAccountId) [OBLIGATORIO PRIMERA POSICIÓN]:\n'
  +'      * id="12312312312" ó  id="nombreusuario"\n'
  +'   * Fecha en la que se desea simular la ejecución del script [OBLIGATORIO SEGUNDA POSICIÓN]:\n'
  +'      * date="2021-08-17T03:00:00.007Z"\n'
  +'   * Nombre de la campaña a la que pertenece la cuenta [OBLIGATORIO TERCERA POSICIÓN]:\n'
  +'      * campaign="CAMPAÑA DE PRUEBA"\n'
  +'   * Traer posts desde el principio de la campaña, sino se pasa el parámetro trae desde el último guardado en la DB:\n'
  +'      * force_all=true\n' 
  +'   * Interpretar el parámetro "id" como nombre de usuario del link de la cuenta, sino, se interpreta como ID numérico (fbAccountId)\n'
  +'      * is_username=true\n'
  +'   * Usar un rango de fechas custom para ir a buscar posts a FB, sino se pasa el parámetro se usa las fechas de la campaña:\n'
  +'      * custom_range=true\n'
  +'   * Fecha custom de inicio para ir a buscar posts en FB.\n'
  +'      * custom_since="2021-08-17T03:00:00.007Z"\n'
  +'   * Fecha custom de fin para ir a buscar posts en FB.\n'
  +'      * custom_until="2021-08-17T03:00:00.007Z"\n'
  +'\n====================================================='
  console.log(help)
  return 1;
}
